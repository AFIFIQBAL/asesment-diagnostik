    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-blue-950 tracking-tight">Senostik V3</h1>
        ...
        <div className="bg-white p-8 md:p-10 rounded-[32px] shadow-2xl shadow-slate-200/60 border border-slate-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-blue-600 text-white rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-blue-700 active:scale-[0.98] transition-all shadow-lg shadow-blue-100 disabled:opacity-70"
            >
              {isLoading ? (
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 text-center">
            <p className="text-sm text-slate-400">
              Belum punya akses? <a href="#" className="text-blue-600 font-bold hover:underline">Hubungi Admin Sekolah</a>
            </p>
          </div>
        </div>
